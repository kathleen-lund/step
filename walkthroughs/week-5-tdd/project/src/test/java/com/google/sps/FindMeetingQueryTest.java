...
public final class FindMeetingQueryTest {
  ...
  public void justEnoughRoomOptional() {
    // Have one mandatory attendee and one optional, with just enough
    // room to only have the mandatory attendee.
    //
    // Mandatory: A
    // Optional : B
    // Events   : |--A--|     |----A----|
  ...
  public void noMandatoryWithGaps() {
    // Have only optional attendees with a few gaps for meetings.
    //
    // Mandatory: none
    // Optional : A, B
    // Events   : |--A--|       |----A----|              |------A------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0930AM, TIME_1000AM, false),
            Arrays.asList(PERSON_B)),
        new Event("Event 4", TimeRange.fromStartEnd(TIME_1200PM, TIME_0130PM, false),
            Arrays.asList(PERSON_A, PERSON_B)));
  ...
  public void noMandatoryWithoutGaps() {
    // Have only optional attendees and no gaps for meetings.
    //
    // Mandatory: none
    // Optional : A, B
    // Events   : |----A----|
    ...
    MeetingRequest request = new MeetingRequest(Collections.<String>emptyList(), DURATION_30_MINUTES);
    request.addOptionalAttendee(PERSON_A);
    request.addOptionalAttendee(PERSON_B);
